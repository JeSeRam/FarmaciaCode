...
public class FRMEdita extends javax.swing.JInternalFrame {
     ...
     * @param Perfil
     */
    public FRMEdita(ClsPerfil Perfil) {
        Registro = Perfil;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText(Glosario.Glosario.Perfil.FRMEdita_getTitulo());
        ...
        jScrollPane1.setViewportView(jpnBase);
    ...
    private final long NumeroDePantalla = 7;
